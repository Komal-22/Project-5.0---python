...
class NewsApp():
    def __init__(self, app):
        ...
        self.app.geometry("1870x600")
        
        ## create some variables
        self.NewsCategoryButton = []
        self.newsCategories = ["general", "entertainment", "business", "health", "science", "technology"]
        ...
        light_blue = '#0066CC'
        font_color = 'white'
        self.title = Label(self.app, text="News App", font=("rockwell bold", 30), bg=bluee,fg=font_color,relief=GROOVE,pady=2,bd=12).pack(fill=X)
        
        F1 = Label(self.app,bg=bluee,fg=font_color,text="Category", font=("roboto slab", 20, "bold"),relief=GROOVE,bd=12)
        F1.place(x=0, y=80, width=300, relheight=0.88)   ### at what coordinate of window you want to place it
        
        for i in range(len(self.newsCategories)):
            b = Button(F1, text=self.newsCategories[i].upper(),font=("roboto slab", 20, "bold"), bd=7, width=20,height=2,bg=light_blue,fg=bluee)
        ...
        self.textarea = Text(F2,yscrollcommand=scroll_y.set,font=("Lora bold",15),bg=bluee,fg=font_color)
    ...
    def NewsArea(self, event):
        ...
        apiKey = "e5d7050ae0674a29860976bcfafe9f02"
...
app = Tk()
NewsApp(app)
app.state("zoomed")   ## always open window in full screen
